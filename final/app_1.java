...
public class app_1 extends JFrame implements ActionListener{
    ...
    public app_1(){
     ...
     ImageIcon icon_ken = loadIcon(imagePathknife, 75, 75); // 呼叫自訂方法讀圖
     ...
     // --- 設定目標 (Target) ---
     // 原本程式碼這裡有重複宣告錯誤，已修正
     ImageIcon icon_target = loadIcon(imagePathtree);
     if (icon_target.getIconWidth() == -1) {
     imageLabel_target.setOpaque(true);
     imageLabel_target.setBackground(Color.BLUE);
     imageLabel_target.setText("目標");
     }
